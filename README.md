...
| [AWS Control Tower with CrowdStrike](Control-Tower) | Configure AWS Control Tower to register new AWS accounts with CrowdStrike Discover and CrowdStrike Horizon. |
