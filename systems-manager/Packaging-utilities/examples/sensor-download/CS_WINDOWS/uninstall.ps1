...
$uninstallArgs = '/uninstall /quiet' + $env:SSM_CS_UNINSTALLPARAMS

if ($env:SSM_CS_MAINTENANCE_TOKEN) {
    $uninstallArgs += ' SSM_CS_MAINTENANCE_TOKEN=' + $env:SSM_CS_MAINTENANCE_TOKEN
}
