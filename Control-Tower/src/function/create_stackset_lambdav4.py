...
def lambda_handler(event, context):
    try:
        ...
        #
        CrowdstrikeTemplateUrl = f'https://crowdstrike-sa-resources-ct-{AwsRegion}.s3.amazonaws.com/ct_crowdstrike_stacksetv4.yaml'
        ...
        if event['RequestType'] in ['Create']:
            ...
            #
            # Adds parameters FalconClientId and FalconSecret
            #
            ...
            CRWD_Discover_paramList = [i for i in CRWD_Discover_paramList if not (i["ParameterKey"] == "s")]
